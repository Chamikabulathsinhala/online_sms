            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div class="row">
                    <div class="col-6 offset-3 mt-5">
                        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Assignments</p>
                    ...
                    <div class="col-11 ms-lg-5 mt-5">
                        <table class="table text-center">
                            ...
                            <tbody>
                                ...
                                if (!isset($_SESSION["userDetails"]["grade_id"])) {
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        $status = Database::search("SELECT * FROM s_m_s.exam_marks a INNER JOIN `assignment_submit_status` b ON a.submit_status_id = b.id WHERE a.student_id = '" . $userID . "' ");
                                        ...
                                        <td><a class="btn btn-primary" href="<?php echo $assigmentPath; ?>">Download</a></td>
                                        <?php
                                        $today = date("Y/m/d");
                                        ...
                                        ?>
                                                <td>
                                                    ...
                                                    <button class="btn btn-outline-success" onclick="uploadAnswer(<?php echo $assigmentID; ?>);">Submit</button>
