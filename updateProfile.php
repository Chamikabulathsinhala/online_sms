                            ...
                            <section style="background-color: #eee;">
                                <div class="container py-5">
                                    <div class="row">
                                        ...
                                        if (!isset($_SESSION["userDetails"]["nic"])) {
                                        } else {
                                                ...
                                                <div class="card-body p-0">
                                                    <ul class="list-group list-group-flush rounded-3">
                                                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                                            ...
                                                            <p class="mb-0">https://ReflexEducationInstitute.com</p>
                                                        </li>
                                                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <button class="btn btn-primary" onclick="updateDetails('<?php echo 'fname'; ?>','1'); ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <button class="btn btn-primary" onclick="updateDetails('<?php echo 'lname'; ?>','2'); ">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </button>
                                                        </div>
                                                    </div>
