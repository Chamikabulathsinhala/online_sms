...
?>
    ...
    <head>
        ...
        <title>SignIn</title>
        <link rel="stylesheet" href="img/logo2 (2).png">
            ...
            <div class="row">
                <div class="login-box ">
                    <div class="text-center">
                        <img src="img/logo2 (2).png" style="height: 250px; background-size: contain;" alt="">
                    </div>
                    ...
                    <form>
                        ...
                        <div class="text-center" id="loginbtn">
                            <a onclick="signin(<?php echo $userType; ?>);" href="#" class="text-Secondary" id="b">
                                <span></span>
                                <span></span>
                                <span></span>
                                <span></span>
                        ...
                        <div class="text-center d-none" id="verifybtn">
                            <a onclick="verify(<?php echo $userType; ?>);" href="#" class="text-Secondary" id="b">
                                <span></span>
                                <span></span>
                                <span></span>
                                <span></span>
                ...
                <div class="col-12 d-none d-lg-block fixed-bottom text-center text-secondary">
                    <p>&copy;2023 ReflexEducationInstitute.lk All Rights Reserved.</p>
                </div>
            </div>
        </div>
